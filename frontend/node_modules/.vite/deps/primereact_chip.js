...
import {
  TimesCircleIcon
} from "./chunk-HXJJ7YIU.js";
import "./chunk-WXMNUML4.js";
import {
  ComponentBase,
  IconUtils,
  ObjectUtils,
...
var Chip = React.memo(React.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React.useContext(PrimeReactContext);
  var props = ChipBase.getProps(inProps, context);
  var elementRef = React.useRef(null);
  var _React$useState = React.useState(true), _React$useState2 = _slicedToArray(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  var _React$useState3 = React.useState(props.id), _React$useState4 = _slicedToArray(_React$useState3, 2), idState = _React$useState4[0], setIdState = _React$useState4[1];
  var _ChipBase$setMetaData = ChipBase.setMetaData({
    props
  }), ptm = _ChipBase$setMetaData.ptm, cx = _ChipBase$setMetaData.cx, isUnstyled = _ChipBase$setMetaData.isUnstyled;
  ...
  var close = function close2(event) {
    var result = true;
    if (props.onRemove) {
  ...
  var createContent = function createContent2() {
    ...
    var icon = props.removeIcon || React.createElement(TimesCircleIcon, _extends({}, removeIconProps, {
    ...
    if (props.image) {
      ...
      content.push(React.createElement("img", _extends({
        alt: props.imageAlt
      }, imageProps, {
    ...
    if (props.label) {
      ...
      content.push(React.createElement("span", _extends({}, labelProps, {
  ...
  return visibleState && createElement2();
}));
Chip.displayName = "Chip";
export {
  Chip
};
//# sourceMappingURL=primereact_chip.js.map
